...
export const metadata: Metadata = {
  ...
  description: "Experience unparalleled luxury at Grand Luxe Hotel. Premium suites, world-class amenities, fine dining, and exceptional service await your arrival.",
  keywords: "luxury hotel, 5-star accommodation, premium suites, fine dining, spa wellness, concierge service",
  metadataBase: new URL("https://grandluxehotel.com"),
  alternates: {
    canonical: "https://grandluxehotel.com"
  },
  openGraph: {
    title: "Grand Luxe Hotel - 5-Star Luxury Experience",
    description: "Discover sophisticated hospitality with timeless elegance and modern luxury at Grand Luxe Hotel.",
  ...
  twitter: {
    ...
    title: "Grand Luxe Hotel - Luxury Redefined",
    description: "Experience unparalleled comfort and elegance at our 5-star hotel.",
